...
public class DBHelper {
    ...
    {
        return db.delete(CEGEP_TABLE, KEY_CEGEPID + "=" + rowId, null) > 0;
    }
    ...
    public Cursor getCegepContact(long rowId) throws SQLException
    {
        Cursor mCursor =
    ...
    //---deletes a particular contact---
    public boolean deleteFriendContact(long rowId)
    {
        return db.delete(FRIEND_TABLE, KEY_FRIENDID + "=" + rowId, null) > 0;
    }
    //---retrieves all the contacts---
    ...
    //---retrieves a particular contact---
    public Cursor getFriendContact(long rowId) throws SQLException
    {
        Cursor mCursor =
                db.query(true, FRIEND_TABLE, new String[] {KEY_FRIENDID,
                                KEY_NAME, KEY_AGE, KEY_CID}, KEY_FRIENDID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
